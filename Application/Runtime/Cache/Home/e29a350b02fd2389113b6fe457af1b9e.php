...
<div class="container" id="bd">
	...
	<?php  $info = M("follow")->where(array('uid'=>session('uid'),'fid'=>$u['id']))->find(); $count = count($info); var_dump($count); ?>
<ul class="breadcrumb"><li><a href="/foot/index.php">首页</a></li>
<li class="active">关于<?php echo ($u["name"]); ?></li>
</ul>
<div class="row">
    <div class="col-lg-3">
            ...
            <div class="panel-body" style="background:url(/foot/Public/img/bg-main.jpg); background-size:100% 120px; background-repeat:no-repeat;">
                <div class="user">
                    ...
                    <h1 style="font-size: 18px;">
                        <?php echo ($u["name"]); ?>                                          </h1>
                    <p><?php echo ($u["sign"]); ?></p>
                                        <div class="button"><a class="follow btn btn-xs btn-success" href="javascript:follow(<?php echo ($u["id"]); ?>);" ><i class="icon icon-plus"></i><?php if($info != ''): ?>Not followed<?php else: ?>关注Ta<?php endif; ?></a><a class="btn btn-xs btn-primary" href=""><i class="icon icon-envelope"></i> 发私信</a></div>
 ...
 <div class="col-lg-6">
    ...
    <script type="text/javascript">
		function follow(fid)
		{
			...
			$.post("<?php echo U('user/center');?>",{"fid":fid},function(data){

				alert(data.msg);
				if (data.ret == 1) {
					$(".follow").html("Not followed");
