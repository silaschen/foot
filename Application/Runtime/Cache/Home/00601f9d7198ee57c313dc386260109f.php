...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $('body').on("click",".fb",function(){
          ...
          $.post("/foot/index.php/home/lesson/addessay",{title:title,forteam:forteam,description:description,content:content,tag:tag},function(data){
                    alert("发表成功"); //下一步跳转到个人文章页面
                    //location.href="/foot/index.php/home/lesson/view/"+"id/"+data.id;
