...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/fuckabc/Public/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="/fuckabc/Public/css/signin.css" rel="stylesheet">
  </head>
...
<script type="text/javascript">
  $(document).ready(function(){
      $("#sign").on('click',function(){
          $.post("/fuckabc/index.php/home/user/signup",{name:$("#name").val(),code:$("#code").val()},function(data){
            if (data.state) {
              $("#warn").html(data.info);
              setTimeout(function(){
                $("#warn").html('登陆中...');
              ...
              setTimeout(function(){
                var name=data.name;
                $.post('/fuckabc/index.php/home/user/gosession',{name:name});

                  location.href="/fuckabc/index.php/home/index/index";
