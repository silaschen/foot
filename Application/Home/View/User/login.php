...
<html lang="en">
  ...
  <body>
    ...
    <div class="input-group">
      <div class="submit-search input-group-addon btn" action="__APP__/home/index/search"><span class=" icon-user"></span></div>
      ...
      <div class="form-group">
    <div class="input-group">
      <div class="submit-search input-group-addon btn" action="__APP__/home/index/search"><span class="icon-lock"></span></div>
       <input type="Password" class="form-control" id="code" placeholder="Password" style="margin-bottom: 0;" required>
        ...
        <p>还没账号？免费注册<a href="__APP__/home/user/sign" class="btn ">注册</a></p>
      </form>
    </div> <!-- /container -->
...
<script type="text/javascript">
  $(document).ready(function(){
      $("#sign").on('click',function(){
          $.post("__APP__/home/user/chklogin",{name:$("#name").val(),code:$("#code").val()},function(data){
