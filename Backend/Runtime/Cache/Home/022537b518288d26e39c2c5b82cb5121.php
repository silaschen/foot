                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody id="tbody">
                                    <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr uid="<?php echo ($item["id"]); ?>">
                                           
                                            <td><?php echo ($item["id"]); ?></td>
                                            <td><?php echo ($item["name"]); ?></td>
                                            <td><?php echo ($item["password"]); ?></td>
                                            <td><a class="bb btn btn-info" href="javascript:remove(<?php echo ($item['id']); ?>)"><i class=" icon-trash"></i></a>&nbsp<a class="up btn btn-info"  uid="<?php echo ($item["id"]); ?>"><i class="icon-edit"></i></a></td>
...
function remove(id){
    var r = confirm("are u sure u wanna delete this user?");
