     ...
     <ul class="nav" id="main-menu">
		...
		<div class="col-md-12">
              ...
              <label>password</label>
									<input type="password" name="password" class="form-control" placeholder="the title" value="<?php echo ($info["password"]); ?>">
...
<script type="text/javascript">
      ...
      $('body').on("click",".fb",function(){
          ...
          $.post("/foot/admin.php/Home/Access/adduser",{id:id,name:name,password:password},function(data){
