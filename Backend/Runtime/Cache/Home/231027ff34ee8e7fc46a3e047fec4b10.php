...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="/foot/admin.php/home/user/logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
     ...
     <ul class="nav" id="main-menu">
		...
		<div class="col-md-12">
              ...
              <label>Name</label>
									<input type="text" name="name" class="form-control" placeholder="name  of the role" value="<?php echo ($info["name"]); ?>">


							</div>
							<div class="form-group">
              <label>remark</label>
									<input type="remark" name="remark" class="form-control" placeholder="the remark" value="<?php echo ($info["remark"]); ?>">
...
<script type="text/javascript">
      ...
      $('body').on("click",".fb",function(){
          ...
          if(name==""){
            ...
            $("input[name='remark']").next().remove();
            $("input[name='remark']").after("<p>不能为空</p>");
          }
          ...
          $.post("/foot/admin.php/Home/Access/addrole",{id:id,name:name,remark:remark},function(data){
                    alert("edit成功"); //下一步跳转到个人文章页面
