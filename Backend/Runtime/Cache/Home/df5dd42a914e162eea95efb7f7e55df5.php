...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="/foot/admin.php/home/user/logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
     ...
     <ul class="nav" id="main-menu">
		...
		<div class="col-md-12">
					<form  action="<?php echo U('Access/accessuser');?>" method="POST">
          <input type="hidden" name="user_id" value="<?php echo ($uid); ?>">
          <?php if(is_array($access)): foreach($access as $key=>$arr): ?><input type="checkbox" name="role_id[]"  value="<?php echo ($arr["id"]); ?>"><?php echo ($arr["name"]); ?>&nbsp<?php endforeach; endif; ?>
    ...
    var role = <?php echo ($have); ?>;
      $.each(role,function(key,obj){


         $("input:checkbox[value='"+obj.role_id+"']").prop("checked",'true');
