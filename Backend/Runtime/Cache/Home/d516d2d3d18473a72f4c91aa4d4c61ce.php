     ...
     <ul class="nav" id="main-menu">
		...
		<div class="form-group">
				...
				<select name="cid" class="form-control">
					<?php if(is_array($team)): foreach($team as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["clubname"]); ?></option><?php endforeach; endif; ?>
				</select>
...
<script type="text/javascript">
	...
	function SaveNew(){
		...
		$.post(location.href,$("#form").serializeArray(),function(data){
			...
			alert(data.msg);
			if (data.ret == 1) {
					location.href = "<?php echo U('Picnews/index');?>";
			}
