                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody id="rank">
                                    <?php if(is_array($model)): foreach($model as $key=>$item): ?><tr uid="<?php echo ($item["id"]); ?>">
                                           
                                            <td><?php echo ($item["id"]); ?></td>
                                            <td><?php echo ($item["clubname"]); ?></td>
                                            <td><?php echo ($item["score"]); ?></td>
                                            <td><?php echo ($item["rank"]); ?></td>
                                            <td><a class="btn btn-info" href="javascript:remove(<?php echo ($item['id']); ?>)"><i class=" icon-trash"></i></a>&nbsp<a href="<?php echo U('Rank/addclub',array('id'=>$item['id']));?>" class="btn btn-info"><i class="icon-edit"></i></a></td>
                                        </tr><?php endforeach; endif; ?>
                                    </tbody>
                                </table>
                                <?php echo ($page); ?>
                                <a href="<?php echo U('Rank/addclub');?>" class="btn btn-info pull-right">Add</a>
                            </div>
                        </div>
                    </div>
	</div>
...
function remove(id){
    var r = confirm("are u sure u wanna delete this club?");
    if (r == true) {
         $.post(location.href,{"id":id},function(data){       
                    if (data.ret == 1) {
                        //delete the data successfully
                        $("tr[uid='"+data.id+"']").remove();
                    }
            },'JSON');
    }  
}
